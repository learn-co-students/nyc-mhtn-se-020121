...
Student has many courses, has many tutors through courses
Tutor has many courses, has many students through courses

Course JOINS 1 student with 1 tutor
...
- `Student#tutors`
  - returns a unique array of all of the `Tutor` instances that are tutoring the `Student`.
